...
cl.login(token="EnMHqB5qkBGTLih5Dn5b.w6+8YbOkbOMyiHAGbC+hcW.SMQemewtGLqd7novMA8U6+2MpEqSyJFLV7btnl2TQUQ=")
cl.loginResult()

ki = LINETCR.LINE() #Bot 1
ki.login(token="En8FflMD0oRd20FOPNEb.VQTBchP8LxZ1o0Ed5rS4AW.Bvvb/PmU5GQ246wVifY6u4m/03Cp4aEEDpfiokhTJiY=")
ki.loginResult()

kk = LINETCR.LINE() #Bot 2
kk.login(token="EnyyP3FnqbR4Ddv6tph1.wOe3+tIdNxRJik2Eaf7nOq.MTbK+6q8rqy36wphvHD0NdTz844q27wep3NOxGKYNPw=")
kk.loginResult()

kc = LINETCR.LINE() #Bot 3
kc.login(token="EnvA0mRaqDGWK4pqbcIb.j0tevqX/kt6xRCOKoax7sW.VgmzmUTZDZCw+vodgTWEAhA+ewcilKJC5Nh4rA26zMs=")
kc.loginResult()

ks = LINETCR.LINE() #Bot 4
ks.login(token="EnxryP54vgnTZ027V5Xc.64p7hMq5ZbXymY+T0gu3Na.AjTv4jfSLiR2A9G72j5/Z1l9mvqAHEm0p8PUmqb5aEg=")
ks.loginResult()

ka = LINETCR.LINE() #Bot 5
ka.login(token="En2o34ILE94CEsjJKjgd.qcJOSgzQEpbuah+2LTD5Bq.rVBiEDNRjY54K68wbnExXBmxPv2DSFLH47JOuiUKavA=")
ka.loginResult()

kb = LINETCR.LINE() #Bot 6
kb.login(token="En53CQef1vEI8Or1LZb9.Eh+xAjKRse5Gp+veh562Mq.5V2YcHfczSu0qsOI1kc8R/NaO0yKqKAMwgX9obyEWmg=")
kb.loginResult()

ko = LINETCR.LINE() #Bot 7
ko.login(token="Enrdx98JpVSd3NcXKcca.ofPkasavZhLKD4OwvrsSMG.5T91pDMwI7V9vMHePnTCNk+GqrTM1n55HwdWWKgzJss=")
ko.loginResult()

ke = LINETCR.LINE() #Bot 8
ke.login(token="EnV4eQCfVVVd45JxtEEa.+swELSmclJDdUyMkvoatAG.JAe7VUIJUZUdRJHP4JPdyKFpW+wyXm18gufpkEbVXPU=")
ke.loginResult()

ku = LINETCR.LINE() #Bot 9
ku.login(token="EnKQE68ouMjR1EpR2uv6.PARWLiQ1yX8Ge7Tqgg1FbG.+MxcWsictb7dO/+OfkK6kpQzzz2USAoey0DBk7ioJPs=")
ku.loginResult()
...
admin=["u5baffcc81a0a0689982216a005cfc70b","uc8e1e36f976e5f4e15e64d9d1cbe1878","ub34b6b9a9ce7d7fca99460477fd3fcf3","udd917e76596789ae636e53342f37f78c","u15be3f8d6ff7f0e53e4cc8bb30c4fa18"]
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Terbuka coyy...")
                else:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup coyy...")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
         ...
         #-------------Fungsi Jam Update Finish-------------------#
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : RH BOT||\n\n>Pelaku tukang ngintip<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n•Kurapan\n\nAmiin Ya Allah\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Intip dulu Kocoyy...\nBaru Ketik Cium\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Guys","Melebu","Bot join"]:
              if msg.from_ in admin:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye bot","Kabur all","ngacir all"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(KAC).sendText(msg.to,"Succes coyy...")
                                except:
...
#---------CCTV-----------
        ...
        if op.type == 17:
           ...
           random.choice(KAC).sendText(op.param1, "FHIRA cwek jutex yg kalo ngomo medok😄😄")
        ...
        if op.type == 15:
           if op.param2 in Bots:
              return
           random.choice(KAC).sendText(op.param1, "baper, kurang kash sayang tu orang kyanya 😂😂😂")

...
cl.login(token="Enwsf9bXqPNOmD3X5iFb.w6+8YbOkbOMyiHAGbC+hcW.XgK/V9GE05rTloSS+qLPwzcFG/cJKNMRzYbt/GoLAPo=")
cl.loginResult()

ki = LINETCR.LINE() #Bot 1
ki.login(token="EnwYu1zqly1vUhDtFXxb.VQTBchP8LxZ1o0Ed5rS4AW.rABZkOhsfIZxpZz+c85UH5RDQmUvlAw4LnffqG8JSA4=")
ki.loginResult()

kk = LINETCR.LINE() #Bot 2
kk.login(token="En6kE3Upm31WxNjiEJB1.wOe3+tIdNxRJik2Eaf7nOq.vDnZDzbErDPaEljofX2wTBu3Ys4Miu/0aGasGens64s=")
kk.loginResult()

kc = LINETCR.LINE() #Bot 3
kc.login(token="En6470B2ldcyOBWq7VKb.j0tevqX/kt6xRCOKoax7sW.ovLIZiKQbLcPgrgf9tKksxGea1WhYd8+JjOKxkxdUfA=")
kc.loginResult()

ks = LINETCR.LINE() #Bot 4
ks.login(token="En7dhYu1itC17kVaF1Gc.64p7hMq5ZbXymY+T0gu3Na.IlDUJHhJZPQ3h/gNZ6RnJtgdT46KE0ELSTxwOGAnWL0=")
ks.loginResult()

ka = LINETCR.LINE() #Bot 5
ka.login(token="EneISCYlCY1qy8RsCQdd.qcJOSgzQEpbuah+2LTD5Bq.yBurqkGuvEhBI5zL1jj/Ppvhr+rCCC2+4+KFbBRVGL8=")
ka.loginResult()

kb = LINETCR.LINE() #Bot 6
kb.login(token="EnQA0Z9OkC0eYoOeRNQ9.Eh+xAjKRse5Gp+veh562Mq.1amlIgjmrptvE9PEK2e1ogXsyPdgXhmbrOw5D+yH1sY=")
kb.loginResult()

ko = LINETCR.LINE() #Bot 7
ko.login(token="EnUcxAkiqoVCx9cDw5Ua.ofPkasavZhLKD4OwvrsSMG.mBNjWHcbTsNDxA+HwhLEAcWJmA6f5QBCjgxXvdPoHQE=")
ko.loginResult()

ke = LINETCR.LINE() #Bot 8
ke.login(token="EnsDwYWtnYoKIUV0fq8a.+swELSmclJDdUyMkvoatAG.Xh0L47fgFSaCkRlHAKI0gk4qUXuizc9yVJfQXjuK8JM=")
ke.loginResult()

ku = LINETCR.LINE() #Bot 9
ku.login(token="EnVGGuO69ocg0ZIklI16.PARWLiQ1yX8Ge7Tqgg1FbG.FQDTrknympH6mAd1E6qxaC12az7XfEE3T3OnsFHhj9A=")
ku.loginResult()

...
cl.login(token="EnNNs07FZntkYxQhOR0b.w6+8YbOkbOMyiHAGbC+hcW.CE8+hJ2WnNbK1Bt1j3mjOQfQCIAg3eAADGkMdA+3a60=")
cl.loginResult()

ki = LINETCR.LINE() #Bot 1
ki.login(token="Enx6teJEXTQhHxFS0bmb.VQTBchP8LxZ1o0Ed5rS4AW.cBQmhbRNwEkWUQ86BidfuEFB+GofVMKHmEnrNszjqaI=")
ki.loginResult()

kk = LINETCR.LINE() #Bot 2
kk.login(token="End18izHP00i804uNdL1.wOe3+tIdNxRJik2Eaf7nOq.L+O+fYxs1G++So/BeBmMHRA3UNd+HE1y1b4WP5Bdi24=")
kk.loginResult()

kc = LINETCR.LINE() #Bot 3
kc.login(token="End18izHP00i804uNdL1.wOe3+tIdNxRJik2Eaf7nOq.L+O+fYxs1G++So/BeBmMHRA3UNd+HE1y1b4WP5Bdi24=")
kc.loginResult()

ks = LINETCR.LINE() #Bot 4
ks.login(token="EnUThEOmw1UexwTNFhVc.64p7hMq5ZbXymY+T0gu3Na.U/8YOEb2tUuhSknCoYt7FdmIjcCUjTFilJDxesy4zTY=")
ks.loginResult()

ka = LINETCR.LINE() #Bot 5
ka.login(token="EngWTKOF7R2KZ7aRZl4d.qcJOSgzQEpbuah+2LTD5Bq.WoHBKwHC5WbKFulW6u7j7y1S1r7PJxSQhGZD2OdSwNI=")
ka.loginResult()

kb = LINETCR.LINE() #Bot 6
kb.login(token="EnD1Z5WutUUEwYfbipE9.Eh+xAjKRse5Gp+veh562Mq.plq3FcPz4rDEessheWwrv3Q9c/3HcLkNJurFtIkaYAU=")
kb.loginResult()

ko = LINETCR.LINE() #Bot 7
ko.login(token="EnWzZVJ8OtMod1SmZFca.ofPkasavZhLKD4OwvrsSMG.A2cYKv190dGeLuQIQE7hiOSm6yYoN4cbAQ3858qeQLU=")
ko.loginResult()

ke = LINETCR.LINE() #Bot 8
ke.login(token="EnMcgELtGUighKDN1vJa.+swELSmclJDdUyMkvoatAG.1/mUf4ODEr9qBimtJ9SmUhrnV3ifeyS6XRL8dD5vDbE=")
ke.loginResult()

ku = LINETCR.LINE() #Bot 9
ku.login(token="EnZmeUxxeD2Aqij8fWN6.PARWLiQ1yX8Ge7Tqgg1FbG.vGrWwLXyDhQki/aFTyZpIhCznQ9Mk6eGXUL7kqT1f18=")
ku.loginResult()

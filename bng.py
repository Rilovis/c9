...
satpam.login(token="EnUmY6A3ILVkSL930V9b.w6+8YbOkbOMyiHAGbC+hcW.qemGLeP9Zk00ToUUaCUAAJyFV5qPCrdfIHmTsCQUgXA=")
satpam.loginResult()

cl = LINETCR.LINE() #Uzumaki Boruto
cl.login(token="EngKEUaOkJssihyaJSnb.VQTBchP8LxZ1o0Ed5rS4AW.ujdEU5mbOFQR1WEzAX5bVhJY4dQ/Z2nR5QXvuC4lqnY=")
cl.loginResult()

ki = LINETCR.LINE() #mithsuki
ki.login(token="Ent9xx7DB8yvUOkaKxf1.wOe3+tIdNxRJik2Eaf7nOq.MC8eFdDl4Agvl5z1f4Jf+OkwT8Ya4gBCrpWWUw4cN0Y=")
ki.loginResult()

kk = LINETCR.LINE() #Sarada Uchiha
kk.login(token="EnNFGlrnRlvDqH6kMFdb.j0tevqX/kt6xRCOKoax7sW.+3MbSBh7T6aQLhEXe3hbOQkvSu/cq+11NSLMk2HHLoU=")
kk.loginResult()

kc = LINETCR.LINE() #Kagura
kc.login(token="EncIq0XDDZ81SX3kUrPc.64p7hMq5ZbXymY+T0gu3Na.E9jZDc0tpTRhy/xlaNL13UnuComVAN523Bm6tlRWdFI=")
kc.loginResult()

ks = LINETCR.LINE() #metal lee
ks.login(token="EnhLIQFc5NnZkFdHz1qd.qcJOSgzQEpbuah+2LTD5Bq.b8tW3+UdHGLAS5jE1j7zAsvVWTemNDreRTTUa/kRPeE=")
ks.loginResult()

ka = LINETCR.LINE() #Shikadai Nara
ka.login(token="EnnfoqyvhmTJa7Adhyl9.Eh+xAjKRse5Gp+veh562Mq.eeV7O17QeLAlB0PZS53b6M1QrlO3EjlIGULOGzN/UC4=")
ka.loginResult()

kb = LINETCR.LINE() #Inojin Yamanaka
kb.login(token="EnO1qe6btZU5nl1pSMGa.ofPkasavZhLKD4OwvrsSMG.qVOkFw/a/JhuJgYqTBwFyOzMqWlQY4bsrbF7f+St3qo=")
kb.loginResult()

ko = LINETCR.LINE() #Chocho Akimichi
ko.login(token="EnLhIhITbpUU1BrK7sta.+swELSmclJDdUyMkvoatAG.xfUWoHJ+3tHjQ22SdIPaxwKQAv7ihQZRwfegBVuChUE=")
ko.loginResult()

ke = LINETCR.LINE() #shinki
ke.login(token="EnwlTBccBs5nJkIoAGR6.PARWLiQ1yX8Ge7Tqgg1FbG.NZuRo1xwojEeYVjhNRvpLXeiv50YrVg1MwDMfmRrxMY=")
ke.loginResult()

ku = LINETCR.LINE() # yodo
ku.login(token="En9zrbwdrZv0fSADfmb0.B7g9A1RW8NU9Ui7lAHrOWa.w6pPp1IXKBhEfMosWAvyMoS4ut0f18mxuh1K3KsJgLM=")
ku.loginResult()
...
k1.login(token="EnXwxzb6eIJTy8BJ5FGd.t9bOCFBZsWK6oxk4TD6ppq.Oa5fHMxmw00FFBwm/ZV10ewkZ+O77nZH9/qybc6o7mY=")
k1.loginResult()

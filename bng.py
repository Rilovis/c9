...
satpam.login(token="EnOCmIAHz03m3bGsNFkb.w6+8YbOkbOMyiHAGbC+hcW.WhD2IFvRtkq4Jl3c6by+2yb1TJtdZmTW10v/SGcyCg8=")
satpam.loginResult()

cl = LINETCR.LINE() #Uzumaki Boruto
cl.login(token="EnThQOJgzFuDxdT9eZPb.VQTBchP8LxZ1o0Ed5rS4AW.ffe+N9JftlMq7UWoCy3wydctOYGIImUNEmFEFTilWuc=")
cl.loginResult()

ki = LINETCR.LINE() #mithsuki
ki.login(token="Env1M3b8wZC6Riv61nm1.wOe3+tIdNxRJik2Eaf7nOq.bwMFgN4x6faxUUxBddmflbr4NOl9YI2p34PJi4JBEJI=")
ki.loginResult()

kk = LINETCR.LINE() #Sarada Uchiha
kk.login(token="EnjwoDejC77IAmPw8V2b.j0tevqX/kt6xRCOKoax7sW.vq2RpXiIc8ACUweo9rbMXpW0hkp1lXUhGS5sxYr8R88=")
kk.loginResult()

kc = LINETCR.LINE() #Kagura
kc.login(token="EnbgQZXQVm9cqP5ggCqc.64p7hMq5ZbXymY+T0gu3Na.d0Y/OYGoN1vNyN6XTEqcP4xBz8j2cRoZOpNudn+onWw=")
kc.loginResult()

ks = LINETCR.LINE() #metal lee
ks.login(token="EnQnPI6DlNMPC962IMXd.qcJOSgzQEpbuah+2LTD5Bq.9EqANdyuBDj8xMoLKNhLvmSCI9gJB5zWcU1BPL6kN7k=")
ks.loginResult()

ka = LINETCR.LINE() #Shikadai Nara
ka.login(token="EnVY2Zbc3QRSY1jFFXt9.Eh+xAjKRse5Gp+veh562Mq.KRF23+xOS3oAO76eVwQbU9imWRRos/jHSTehXtJ2U4U=")
ka.loginResult()

kb = LINETCR.LINE() #Inojin Yamanaka
kb.login(token="EnfGL52v63rNxtaBURka.ofPkasavZhLKD4OwvrsSMG.3J4+kpKoqDoi6/+2C3+Np/zvMbO4Xacz8AiYM8f/Nbw=")
kb.loginResult()

ko = LINETCR.LINE() #Chocho Akimichi
ko.login(token="EnnTV88mhLWjPTnsvjCa.+swELSmclJDdUyMkvoatAG.qgi0pw27PKaUKy1QarqZzLBE9KaKQvtY99fN9ee3am4=")
ko.loginResult()

ke = LINETCR.LINE() #shinki
ke.login(token="EnI6AKG3e8UfuXQOCT96.PARWLiQ1yX8Ge7Tqgg1FbG.EuxPqWYdXnEp0aZy0UF/Qs1qhUCmy0yVaFrioR83Ewk=")
ke.loginResult()

ku = LINETCR.LINE() # yodo
ku.login(token="En1z2ghcNbemuKcq4r50.B7g9A1RW8NU9Ui7lAHrOWa.3/nR8A4N0D5KEs7VBsFUKzpI0Xfv+Cq70pTBnnF/3nM=")
ku.loginResult()
...
k1.login(token="End1vLzVH4KtB5iHl5Z6.DJfCP5tT35HajOsEmvX6PG.oxFwHwTIkUKG4ZVzuJHFKtdlUJ2EPv9ctQSLa2tIULo=")
k1.loginResult()

print "login success cokk"
reload(sys)
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Terbuka cokkk")
                else:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup cokkk")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu Kocokkk\nBaru Ketil Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","melebu","Join kuy"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","ngacir","Kaboor all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(KAC).sendText(msg.to,"Succes cokkk")
                                except:
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin and owner:
                start = time.time()
                cl.sendText(msg.to, "Sabar cokkk...")
    ...
    for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                ...
                print "Status Sudah di Like cokkk"

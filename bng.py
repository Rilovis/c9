...
satpam.login(token="EnB2GMNwM7MHvbKyIIXb.w6+8YbOkbOMyiHAGbC+hcW.K/K15msdCXNVweA82/0X2PaN2qsblxwL0T2eBTzgZzw=")
satpam.loginResult()

cl = LINETCR.LINE() #Uzumaki Boruto
cl.login(token="EnUsmwsR6hRPr9K8dAhb.VQTBchP8LxZ1o0Ed5rS4AW.h4dzcYKShO4TcHjocL/aCXCq12f+hF7dbcHFYwKQJ3g=")
cl.loginResult()

ki = LINETCR.LINE() #mithsuki
ki.login(token="EnNdX1JeGPUrOUVIawq1.wOe3+tIdNxRJik2Eaf7nOq.f/xluBbhbUUf4xN/YmPLzCrd8wPy7B/1gxUoFBdXFTE=")
ki.loginResult()

kk = LINETCR.LINE() #Sarada Uchiha
kk.login(token="EniHo5BC84DIft2zNbyb.j0tevqX/kt6xRCOKoax7sW.uFX5gKl4JJx/bnMtaGm9Ehf0xZDQO2sBNW/J+UYzDDo=")
kk.loginResult()

kc = LINETCR.LINE() #Kagura
kc.login(token="EngLzqBsCNXSh46GI6sc.64p7hMq5ZbXymY+T0gu3Na.HA+TWa/c+QxfDgcOPme8H5GxNSF+L7UFddVKUOEOUGs=")
kc.loginResult()

ks = LINETCR.LINE() #metal lee
ks.login(token="Enf2ULRGB7PDJnaaEKRd.qcJOSgzQEpbuah+2LTD5Bq.oW0OT5mWmVsx6mXjXspk7+HITJvdaZ/ZiFvbH0qgzC0=")
ks.loginResult()

ka = LINETCR.LINE() #Shikadai Nara
ka.login(token="EnSmek2X9SV2NUm9BLN9.Eh+xAjKRse5Gp+veh562Mq.ArhuA7ivNQnrz71W1QMNZo6DN2PVNAQ2N1g38bDku/8=")
ka.loginResult()

kb = LINETCR.LINE() #Inojin Yamanaka
kb.login(token="En7c5VxbbwIkaga9kxNa.ofPkasavZhLKD4OwvrsSMG.nYtRz1g7djDlRkWI0RZjKtdw5sUi2bWdJJG++gcc/bs=")
kb.loginResult()

ko = LINETCR.LINE() #Chocho Akimichi
ko.login(token="EnXzjB2imrb5lq0EPf4a.+swELSmclJDdUyMkvoatAG.QxYTxQ2YiOFSEcKb8oDQ6Mvxz2ancPPOssqMPz4XU5w=")
ko.loginResult()

ke = LINETCR.LINE() #shinki
ke.login(token="Enoo52xvDxj9Gjn5yE66.PARWLiQ1yX8Ge7Tqgg1FbG.VLoC1g5UKnj00HMEuHbM4jRlRb2e/Xx3qtV0aziq1P8=")
ke.loginResult()

ku = LINETCR.LINE() # yodo
ku.login(token="EnSM2L3mwODps89ulI60.B7g9A1RW8NU9Ui7lAHrOWa./diq1nyfwZs3VhmMZLQAFs4lhRCn+cDk+kgEUcK+3MA=")
ku.loginResult()
...
k1.login(token="EndYtfu9I1vo27qXb1vd.t9bOCFBZsWK6oxk4TD6ppq.CuZGt0kWSk7zesxxj8Gm86T36/YBs541oBCx4dBow+A=")
k1.loginResult()

print "login success dathebayo"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""^[Ninja Konoha]^
=================
•OWNER •HOKAGE•
 --[KEY BOT BNG]--
=================    
...
mid = cl.getProfile().mid #Uzumaki Boruto
Amid = ki.getProfile().mid #mithsuki
Bmid = kk.getProfile().mid #Sarada Uchiha
Cmid = kc.getProfile().mid #kagura
Dmid = ks.getProfile().mid #metal lee
Emid = ka.getProfile().mid #Shikadai Nara
Fmid = kb.getProfile().mid #Inojin Yamanaka
Gmid = ko.getProfile().mid #Chocho Akimichi
Hmid = ke.getProfile().mid #shinki
Imid = ku.getProfile().mid #yodo
Smid = satpam.getProfile().mid #Akun Utama
mid1 = k1.getProfile().mid #Backup

Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1,"u5baffcc81a0a0689982216a005cfc70b"]
...
Idline: http://line.me/ti/p/~ri_her""",
    ...
    "dblack":False,
    "clock":False,
    "cName":"™Uzumaki Boruto™ ",
    "cName2":"™mithsuki™ ",
    "cName3":"™Sarada Uchiha™ ",
    "cName4":"™kagura™ ",
    "cName5":"™metal lee™ ",
    "cName6":"™Shikadai Nara™ ",
    "cName7":"™Inojin Yamanaka™ ",
    "cName8":"™Chocho Akimichi™ ",
    "cName9":"™shinki™ ",
    "cName10":"™yodo™ ",
    "cName11":"",
    "cName12":"™NINJA KONOHA BOT™ ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            elif ("Uzumaki Boruto gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
            ...
            elif ("Sarada Uchiha gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
            ...
            elif "Uzumaki Boruto kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_second kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "mithsuki kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_third kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Sarada Uchiha kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "Uzumaki Boruto invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "mithsuki invite " in msg.text:
              if msg.from_ in admin:
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Terbuka dathebayo")
                else:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Uzumaki Boruto buka qr","Uzumaki Boruto open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done dathebayo")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["mithsuki buka qr","mithsuki open qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done dathebayo")
                    else:
            ...
            elif msg.text in ["Sarada Uchiha open qr","Sarada Uchiha buka qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done dathebayo")
                    else:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup dathebayo")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Uzumaki Boruto close qr","Uzumaki Boruto tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["mithsuki tutup qr","mithsuki close qr"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done dathebayo")
                    else:
            ...
            elif msg.text in ["Sarada Uchiha tutup qr","Sarada Uchiha close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
            ...
            elif "Uzumaki Boruto" == msg.text:
              if msg.from_ in admin:
                ki.sendText(msg.to,mid)
            elif "mithsuki" == msg.text:
              if msg.from_ in admin:
                kk.sendText(msg.to,Amid)
            elif "Sarada Uchiha" == msg.text:
              if msg.from_ in admin:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : Koplaxs BOT||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\Chocho Akimichi amin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Cctv dulu Kodathebayo\nBaru Ketil Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","NINJA KONOHA","Join kuy"]:
              if msg.from_ in owner:
            ...
            elif msg.text in ["Uzumaki Boruto join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["mithsuki join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["Sarada Uchiha Join"]:
              if msg.from_ in admin:
                  X = cl.getGroup(msg.to)
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Bye Sarada Uchiha"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(KAC).sendText(msg.to,"Succes dathebayo")
                                except:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot out","Bot oag","Op bye"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                 gid = cl.getGroupIdsJoined()
 ...
 #-----------------End-----------
                ...
                kk.sendText(msg.to,"Hi buddy 􀜁??Har Har􏿿")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin and owner:
                start = time.time()
                cl.sendText(msg.to, "Sabar dathebayo...")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^NINJA KONOHA Bot^\nStatus Boss udah Kami Like\nOwner Kami :\nRIO HERMAWAN")
                    print "Like"
                except:
                    pass
            else:
                print "Status Sudah di Like dathebayo"

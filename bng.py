...
satpam.login(token="EngPwahGCnJ7Iae3eu1b.w6+8YbOkbOMyiHAGbC+hcW.5EYhGp/b7GtTfsZI/O7UNNECnQQRBN5NB8YW33mCkic=")
satpam.loginResult()

cl = LINETCR.LINE() #Uzumaki Boruto
cl.login(token="Enf1JGatxnyDOPMD8i0b.VQTBchP8LxZ1o0Ed5rS4AW.XkXX2ycMtPq2zLVy24IsJLnZ7Ufvog6R/Z3PkkZdzzw=")
cl.loginResult()

ki = LINETCR.LINE() #mithsuki
ki.login(token="EnDXhbgPHPFuGeWgbmW1.wOe3+tIdNxRJik2Eaf7nOq.7gl/Rn6t8dnuIOTNq3tugcEm+qQ1L0MXkjLhLWgevs0=")
ki.loginResult()

kk = LINETCR.LINE() #Sarada Uchiha
kk.login(token="EnbbtXUQcQbuTk1I9eeb.j0tevqX/kt6xRCOKoax7sW.6pRMmqSSWwXGYxz/SXRcjGDen+JzXwtwctNZJwab0gQ=")
kk.loginResult()

kc = LINETCR.LINE() #Kagura
kc.login(token="EnkRs1fiYu0DOzrti35c.64p7hMq5ZbXymY+T0gu3Na.UAkliHVdg2ez78XIctXiyIjPtE7xRPHinYjibPKxXtA=")
kc.loginResult()

ks = LINETCR.LINE() #metal lee
ks.login(token="EnTW7uoTEUisObAjYuNd.qcJOSgzQEpbuah+2LTD5Bq.+72ehQ6aQIttu+m90Lam1jRMpd0k2emnJNDiOfp44w8=")
ks.loginResult()

ka = LINETCR.LINE() #Shikadai Nara
ka.login(token="EnnhIsRO6lnBY58IsGk9.Eh+xAjKRse5Gp+veh562Mq.IpYcz9+9EHSnbgtSD184tBTWDtVN5+prIK9u3KmYxao=")
ka.loginResult()

kb = LINETCR.LINE() #Inojin Yamanaka
kb.login(token="EnUQpiZiPybdikNnYFya.ofPkasavZhLKD4OwvrsSMG.ahr23PkF2AFotnUyaShUiB6j7TE5djefG+VQCS6zjF4=")
kb.loginResult()

ko = LINETCR.LINE() #Chocho Akimichi
ko.login(token="EnBkVnePeuBw2utIJA7a.+swELSmclJDdUyMkvoatAG.4qoRKUEjFph1cdaQQ3UqIKekXXWmm2L3VYOxSe/wp8s=")
ko.loginResult()

ke = LINETCR.LINE() #shinki
ke.login(token="EnwWLS4J0FAgNAqNyQa6.PARWLiQ1yX8Ge7Tqgg1FbG.mI3n7y4ykIsQIRj8UnFZrRkOd5XLHvogQtw2BlxnbCw=")
ke.loginResult()

ku = LINETCR.LINE() # yodo
ku.login(token="EnJrm0JpA1Xt64gisD20.B7g9A1RW8NU9Ui7lAHrOWa.IVZSnAwTuwXvxVsNiv9BL92jdFgXbQUWo3NjOJLUwb8=")
ku.loginResult()
...
k1.login(token="EnqYCdp9UmmreIlk7Kj6.DJfCP5tT35HajOsEmvX6PG.J+peaOvBWJjpoO2tW0DLnWXXwsb1dVFahSMhJocWYkU=")
k1.loginResult()
